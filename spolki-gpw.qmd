...
companies <- data.frame(
  ticker = c(
    "ACP", "ALE", "ALR", "APR", "ASB", "BDX", "BFT", "CAR", "CCC", "CDR", "CPS", "CRI", "DAD", "DIA", "DIG", "DNP", 
    "ENA", "IFR", "JSW", "KGH", "KRU", "KTY", "LBW", "LPP", "MBK", "MIL", "OPL", "PEO", "PEP", 
    "PGE", "PKN", "PKO", "PZU", "RBW", "SNT", "SPL", "TPE", "XTB", "ZAB"
  ),
  name = c(
    "Asseco Poland", "Allegro.eu", "Alior Bank", "Auto Partner", "Asbis", "Budimex", "Benefit Systems", "Inter Cars", "Grupa CCC", "CD PROJEKT", "Cyfrowy Polsat", "Creotech", "Dadelo", "Diagnostyka", "Digital Network", "DINO POLSKA", 
    "ENEA", "Investment Friends", "Jastrzębska Spółka Węglowa", "KGHM Polska Miedź", "KRUK", "Grupa Kęty", "Lubawa", "LPP", "mBank", "Bank Millennium", "Orange Polska", "Bank Pekao", "Polenergia", 
    "PGE Polska Grupa Energetyczna", "ORLEN", "PKO Bank Polski", "PZU", "Rainbow Tours", "Synektik", "Santander Bank Polska", "Tauron Polska Energia", "XTB", "Żabka Group"
  ),
