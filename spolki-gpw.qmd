...
companies <- data.frame(
  ...
  name = c("Allegro.eu", "Alior Bank", "Grupa CCC", "CD PROJEKT", "DINO POLSKA", "KGHM Polska Miedź", "Lubawa", "LPP", "Bank Pekao", "ORLEN", "PKO Bank Polski", "PZU", "Santander Bank Polska", "XTB", "Żabka Group"),
