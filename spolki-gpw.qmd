...
companies <- data.frame(
  ticker = c(
    ...
    "EAT", "ECH", "ELT", "ENA", "ENG", "ENT", "EUR", "FRO", "GPW", "GPP", "GRX", "IFR", "ING", "JSW", "KGH", "KER", "KRU", "KTY", "LBW", "LPP", "LWB", "MBK", "MBR", "MDG", "MIL", "MLS", "MRB", "MUR",
  ...
  name = c(
    ...
    "AmRest", "Echo Investment", "Elektrotim", "ENEA", "ENERGA", "Enter Air", "Eurocash", "Ferro", "Giełda Papierów Wartościowych", "Grupa Pracuj", "GreenX Metals", "Investment Friends", "ING Bank Śląski", "Jastrzębska Spółka Węglowa", "KGHM Polska Miedź", "Kernel Holding", "KRUK", "Grupa Kęty", "Lubawa", "LPP", "Lubelski Węgiel Bogdanka", "mBank", "Mo-BRUK", "Medicalgorithmics", "Bank Millennium", "ML System", "MIRBUD", "Murapol",
