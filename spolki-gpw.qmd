...
companies <- data.frame(
  ticker = c(
    ...
    "EAT", "ELT", "ENA", "ENG", "FRO", "GPW", "GPP", "GRX", "IFR", "ING", "JSW", "KGH", "KRU", "KTY", "LBW", "LPP", "MBK", "MBR", "MIL", "MRB", "OPL", "PCO", "PEO", "PEP", "PGE", "PKN", "PKO", "PKP", "PLW", "PXM", "PZU",
    "RBW", "RVU", "SLV", "SNT", "SPL", "TEN", "TOR", "TPE", "TRK", "TXT", "WPL", "XTB", "ZAB"
  ),
  name = c(
    ...
    "AmRest", "Elektrotim", "ENEA", "ENERGA", "Ferro", "Giełda Papierów Wartościowych", "Grupa Pracuj", "GreenX Metals", "Investment Friends", "ING Bank Śląski", "Jastrzębska Spółka Węglowa", "KGHM Polska Miedź", "KRUK", "Grupa Kęty", "Lubawa", "LPP", "mBank", "Mo-BRUK", "Bank Millennium", "MIRBUD", "Orange Polska", "Pepco Group", "Bank Pekao", "Polenergia", "PGE Polska Grupa Energetyczna", "ORLEN", "PKO Bank Polski", "PKP Cargo", "Playway", "Polimex-Mostostal", "PZU",
    "Rainbow Tours", "Ryvu Therapeutics", "Selvita", "Synektik", "Santander Bank Polska", "Ten Square Games", "Torpol", "Tauron Polska Energia", "Trakcja", "Text", "Wirtualna Polska", "XTB", "Żabka Group"
  ),
