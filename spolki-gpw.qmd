...
companies <- data.frame(
  ticker = c(
    "ACP", "ALE", "ALR", "BDX", "BFT", "CAR", "CCC", "CDR", "DIG", "DNP", 
    "JSW", "KGH", "KRU", "KTY", "LBW", "LPP", "MBK", "MIL", "PEO", "PEP", 
    "PGE", "PKN", "PKO", "PZU", "SPL", "TPE", "XTB", "ZAB"
  ),
  name = c(
    "Asseco Poland", "Allegro.eu", "Alior Bank", "Budimex", "Benefit Systems", "Inter Cars", "Grupa CCC", "CD PROJEKT", "Digital Network", "DINO POLSKA", 
    "Jastrzębska Spółka Węglowa", "KGHM Polska Miedź", "KRUK", "Grupa Kęty", "Lubawa", "LPP", "mBank", "Bank Millennium", "Bank Pekao", "Polenergia", 
