...
companies <- data.frame(
  ticker = c(
    "11B", "4MS", "ACP", "ALE", "ALR", "APT", "APR", "ASB", "ATT", "BCX", "BDX", "BFT", "BHW", "CAR", "CCC", "CDR", "CIG", "CLC", "CPS", "CRI", "DAD", "DAT", "DIA", "DIG", "DNP", "DOM", "DVL",
    "EAT", "ECH", "ELT", "ENA", "ENG", "FRO", "GPW", "GPP", "GRX", "IFR", "ING", "JSW", "KGH", "KER", "KRU", "KTY", "LBW", "LPP", "LWB", "MBK", "MBR", "MDG", "MIL", "MLS", "MRB", "MUR",
    "NWG", "NEU", "OPL", "PCO", "PCR", "PEO", "PEP", "PGE", "PKN", "PKO", "PKP", "PLW", "PXM", "PZU", "RBW", "RVU", "SCP", "SGN", "SLV", "SNT", "SPL", "SPR", "STX", "TEN", "TOA", "TOR", "TPE", "TRK", "TXT", "VRG", "WTN", "WPL", "XTB", "ZAB"
  ),
  name = c(
    "11 bit studios", "4Mass", "Asseco Poland", "Allegro.eu", "Alior Bank", "Apator", "Auto Partner", "Asbis", "Grupa Azoty", "Bioceltix", "Budimex", "Benefit Systems", "Bank Handlowy", "Inter Cars", "Grupa CCC", "CD PROJEKT", "CI Games", "Columbus Energy", "Cyfrowy Polsat", "Creotech", "Dadelo", "DataWalk", "Diagnostyka", "Digital Network", "DINO POLSKA", "Dom Development", "Develia",
