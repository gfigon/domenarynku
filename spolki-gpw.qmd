...
companies <- data.frame(
  ticker = c(
    "11B", "4MS", "ACP", "ALE", "ALL", "ALR", "APT", "APR", "ASM", "ASB", "ATT", "BCX", "BDX", "BFT", "BHW", "BMC", "BNP", "CAR", "CCC", "CBF", "CDR", "CIG", "CLC", "CPS", "CRI", "CRJ", "DAD", "DAT", "DIA", "DIG", "DNP", "DOM", "DVL",
  ...
  name = c(
    "11 bit studios", "4Mass", "Asseco Poland", "Allegro.eu", "Ailleron", "Alior Bank", "Apator", "Auto Partner", "ASM Group", "Asbis", "Grupa Azoty", "Bioceltix", "Budimex", "Benefit Systems", "Bank Handlowy", "Bumech", "BNP Paribas Bank Polska", "Inter Cars", "Grupa CCC", "Copernicus", "CD PROJEKT", "CI Games", "Columbus Energy", "Cyfrowy Polsat", "Creotech", "Creepy Jar", "Dadelo", "DataWalk", "Diagnostyka", "Digital Network", "DINO POLSKA", "Dom Development", "Develia",
