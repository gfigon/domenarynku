...
companies <- data.frame(
  ticker = c(
    "ACP", "ALE", "ALR", "APR", "ASB", "BDX", "BFT", "BHW", "CAR", "CCC", "CDR", "CIG", "CPS", "CRI", "DAD", "DIA", "DIG", "DNP", 
    "ENA", "IFR", "JSW", "KGH", "KRU", "KTY", "LBW", "LPP", "MBK", "MIL", "OPL", "PCO", "PEO", "PEP", 
    "PGE", "PKN", "PKO", "PXM", "PZU", "RBW", "SNT", "SPL", "TPE", "TXT", "XTB", "ZAB"
  ),
  name = c(
    "Asseco Poland", "Allegro.eu", "Alior Bank", "Auto Partner", "Asbis", "Budimex", "Benefit Systems", "Bank Handlowy", "Inter Cars", "Grupa CCC", "CD PROJEKT", "CI Games", "Cyfrowy Polsat", "Creotech", "Dadelo", "Diagnostyka", "Digital Network", "DINO POLSKA", 
    "ENEA", "Investment Friends", "Jastrzębska Spółka Węglowa", "KGHM Polska Miedź", "KRUK", "Grupa Kęty", "Lubawa", "LPP", "mBank", "Bank Millennium", "Orange Polska", "Pepco Group", "Bank Pekao", "Polenergia", 
