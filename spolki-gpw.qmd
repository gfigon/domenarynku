...
companies <- data.frame(
  ticker = c(
    ...
    "EAT", "ENA", "ENG", "GPW", "IFR", "JSW", "KGH", "KRU", "KTY", "LBW", "LPP", "MBK", "MIL", "MRB", "OPL", "PCO", "PEO", "PEP", 
    "PGE", "PKN", "PKO", "PXM", "PZU", "RBW", "SNT", "SPL", "TEN", "TPE", "TXT", "WPL", "XTB", "ZAB"
  ),
  name = c(
    ...
    "AmRest", "ENEA", "ENERGA", "Giełda Papierów Wartościowych", "Investment Friends", "Jastrzębska Spółka Węglowa", "KGHM Polska Miedź", "KRUK", "Grupa Kęty", "Lubawa", "LPP", "mBank", "Bank Millennium", "MIRBUD", "Orange Polska", "Pepco Group", "Bank Pekao", "Polenergia", 
    "PGE Polska Grupa Energetyczna", "ORLEN", "PKO Bank Polski", "Polimex-Mostostal", "PZU", "Rainbow Tours", "Synektik", "Santander Bank Polska", "Ten Square Games", "Tauron Polska Energia", "Text", "Wirtualna Polska", "XTB", "Żabka Group"
  ),
