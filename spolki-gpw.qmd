...
companies <- data.frame(
  ticker = c(
    "11B", "4MS", "ACP", "ALE", "ALL", "ALR", "APT", "APR", "ASB", "ATT", "BCX", "BDX", "BFT", "BHW", "BNP", "CAR", "CCC", "CDR", "CIG", "CLC", "CPS", "CRI", "CRJ", "DAD", "DAT", "DIA", "DIG", "DNP", "DOM", "DVL",
    "EAT", "ECH", "ELT", "ENA", "ENG", "FRO", "GPW", "GPP", "GRX", "IFR", "ING", "JSW", "KGH", "KER", "KRU", "KTY", "LBW", "LPP", "LWB", "MBK", "MBR", "MDG", "MIL", "MLS", "MRB", "MUR",
  ...
  name = c(
    "11 bit studios", "4Mass", "Asseco Poland", "Allegro.eu", "Ailleron", "Alior Bank", "Apator", "Auto Partner", "Asbis", "Grupa Azoty", "Bioceltix", "Budimex", "Benefit Systems", "Bank Handlowy", "BNP Paribas Bank Polska", "Inter Cars", "Grupa CCC", "CD PROJEKT", "CI Games", "Columbus Energy", "Cyfrowy Polsat", "Creotech", "Creepy Jar", "Dadelo", "DataWalk", "Diagnostyka", "Digital Network", "DINO POLSKA", "Dom Development", "Develia",
    "AmRest", "Echo Investment", "Elektrotim", "ENEA", "ENERGA", "Ferro", "Giełda Papierów Wartościowych", "Grupa Pracuj", "GreenX Metals", "Investment Friends", "ING Bank Śląski", "Jastrzębska Spółka Węglowa", "KGHM Polska Miedź", "Kernel Holding", "KRUK", "Grupa Kęty", "Lubawa", "LPP", "Lubelski Węgiel Bogdanka", "mBank", "Mo-BRUK", "Medicalgorithmics", "Bank Millennium", "ML System", "MIRBUD", "Murapol",
