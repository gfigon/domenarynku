...
::: {.card title="O spółce"}
**Profil działalności:**  
PKO Bank Polski S.A. to lider sektora bankowego w Polsce. Bank obsługuje blisko 12 mln klientów, oferując pełen wachlarz usług uniwersalnych w segmencie detalicznym i korporacyjnym.

**Strategia i Perspektywy:**  
Strategia banku koncentruje się na transformacji cyfrowej, personlizacji usług z wykorzystaniem AI oraz wspieraniu polskiej gospodarki.
:::

::: {.card title="Segmenty i Produkty"}
**Główne obszary działalności:**
* **Bankowość detaliczna:** Największa baza klientów i lider nowoczesnej bankowości mobilnej (IKO).
* **Bankowość korporacyjna:** Finansowanie polskiego eksportu i strategicznych inwestycji.
* **Grupa Kapitałowa:** Dom maklerski, TFI, Leasing i Ubezpieczenia.
:::

::: {.card title="Wizja"}
**Kierunki rozwoju:**
* Lider cyfryzacji i ekosystemu usług mobilnych.
* Aktywne wspieranie transformacji energetycznej (ESG).
* Dalsza optymalizacja procesów przez AI.
